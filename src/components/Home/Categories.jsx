...
const Categories = () => {
  return (
    <div className="lg:py-20 py-4 grid lg:gap-sections">
      ...
      <div className="grid lg:grid-cols-6 lg:gap-8 gap-4 lg:p-inline p-4">
        {CategoriesData.map((category, index) => (
          <div
            key={index}
            className="border border-black p-4 lg:pt-[25px] hover:border-slate-50 border-opacity-30 rounded  flex lg:grid items-center lg:justify-center gap-4 hover:bg-secondary transition-all duration-300 group"
          >
